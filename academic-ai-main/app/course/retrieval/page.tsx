...
export default function ChatAgentPage() {
      ...
      */}
      <ul>
        <li className="text-l">
          👇
          <span className="ml-2">
            Hello student, ask me anything about your class and I will do my
  ...
  return (
    <ChatWindow
      ...
      placeholder={
        'You can ask me questions such as: "Can you give me the webex link?"'
      }
      emoji=""
      titleText="CS-485 Virtual Assistant Chat"
    ></ChatWindow>
  );
}
